                ...
                <div className="signup-form">
                    <form method="POST" onSubmit={register}>
                        ...
                        <div className="form-group">
                            ...
                            <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" name="email" id="email" className="form-control" placeholder="Enter your email" aria-describedby="helpId" required autoComplete="email" />
